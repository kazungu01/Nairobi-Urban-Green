    ...
    <div>
      <div className="footer-top-wrapper">
        ...
        <div className="footer-right">
          ...
          <a
            href="https://mail.google.com/mail/?view=cm&fs=1&to=nairobiurbangreening@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
            className="contact"
          >
            nairobiurbangreening@gmail.com
          </a>
        </div>
        ...
        <div className="socials">
          ...
          <a
            className="icon-btn"
            href="https://web.facebook.com/profile.php?id=61568534708104&mibextid=rS40aB7S9Ucbxw6v&_rdc=1&_rdr"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Facebook"
          >
          ...
          <a
            className="icon-btn"
            href="https://x.com/Francis08863197"
            target="_blank"
            rel="noopener noreferrer"
